...
const totalDrawsElement = document.getElementById('total-draws');  // Добавьте элемент для ничьих
const totalLossesElement = document.getElementById('total-losses');  // Добавьте элемент для проигрышей
